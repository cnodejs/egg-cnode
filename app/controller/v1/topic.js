...
class TopicController extends Controller {
  async index() {
    ...
    var limit    = Number(ctx.query.limit) || config.list_topic_count;
    var mdrender = ctx.query.mdrender === 'false' ? false : true;
    ...
    const topics = await service.topic.find(query, '', options);
    service.user.findById
